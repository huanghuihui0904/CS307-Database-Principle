...
//                ArrayList<String>content=new ArrayList<>();
                ...
                Columns.addAll(Arrays.asList(m.split("\\|")));
...
//
    ...
    public static void Update(String updateStatement,String table,ArrayList<String>Columns,ArrayList<String> Data,ArrayList<String>content,ArrayList<String>parts) throws SQLException {
...
//            stmt = con.prepareStatement("select * from contract_info where contract_number=? and  product_model=? and salesman_number=?");
    ...
    public static ArrayList<String[]> Select(String table, ArrayList<String>parts , ArrayList<String>Columns, ArrayList<String>Data, String selectStatement){
//        table table = null;
        ArrayList<Integer> INT =new ArrayList<>();
        ArrayList<Integer> DATE =new ArrayList<>();
...
//                        stmt.setString(1, content);
    ...
    private static ArrayList<String[]> load_select(String[] strings,ArrayList<String>Columns,ArrayList<Integer>INT,ArrayList<Integer>DATE,ArrayList<Integer>ColumnsINT,ArrayList<Integer>ColumnsDATE,String table)
            throws SQLException {

        int index=centerLength.get(table);
        String[] fin = new String[index];
        ArrayList<String[]>p=new ArrayList<>();
        if (con != null) {
            int countINT=0;
            int countDATE=0;
